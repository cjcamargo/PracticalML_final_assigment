...
We see that gbm has also a really good overall accuracy: `r round(cmGBM$overall['Accuracy'], 4)`, but random forest y slightly higher: `r round(cmRF$overall['Accuracy'], 4)`  so we will use that model to predict the assigment quiz
